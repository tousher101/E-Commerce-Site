...
export default function womensFashion(){
   ...
   getWomensProduct();
      ...
      const res= await fetchWithAuth(`${BaseURI}/api/admin/searchproductbybarcodewomens?barCode=${barCode}`)
    ...
    return(
        ...
        <div className=" mx-auto w-full overflow-hidden">
           <div className='flex justify-end gap-2 mx-[10px] items-center'>
            ...
            <h1 className='text-center text-3xl text-gray-400 font-semibold'>Women's ({totalProduct})</h1>
