    ...
    return(
        <div className="max-w-[1380px] mx-[10px] overflow-hidden">
            <div className="flex items-center justify-between">
                ...
                <Image src={logo} height={80} width={180} alt="store-logo"/>
                ...
                <div className="flex items-center cursor-pointer">
                    <Image src={playStore} height={65} width={145} alt="google-play-store"/>
                    <Image src={appleStore} height={80} width={180} alt="apple-store"/>
                </div>
            </div>
            ...
            <div className="max-w-[1380px] overflow-hidden flex justify-between mt-[30px]  mb-[10px]">
                ...
                <div className="grid grid-cols-1 text-sm text-gray-600 mt-[10px] gap-1.5">
                   <div className="flex items-start gap-1">
                    <Image src={location} height={15} width={15} alt="location-logo"/>
                    ...
                    <div className="flex items-start gap-1">
                    <Image src={email} height={20} width={20} alt="email-logo"/>
