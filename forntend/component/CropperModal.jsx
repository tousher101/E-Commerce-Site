...
export default function CropperModal({closeModal,onUpload}) {
      ...
      <div className="bg-white p-4 rounded-lg w-[90vw] max-w-md space-y-4">
        ...
        {!imageSrc ? (
          <div className="text-center">
            <button onClick={closeModal} className='fixed lg:bottom-0 lg:translate-y-[-50] md:top-0 md:left-[30px] top-0 left-[30px]  mt-[30px] border border-white h-[60px] w-[60px]
